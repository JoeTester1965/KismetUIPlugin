...
nohup sudo -u pi -H $python_command process_real_time_probes.py $CONFIG_FILE $CSV_FILE 2>/dev/null &
nohup sudo -u pi -H $python_command probe_viewer.py ./probes_archive.csv &> /dev/null &